...
function ChatSideBar({
  ...
  return (
    <nav
      className={`z-100 lg:border-r-gray-300 lg:border-r-1 p-4 fixed top-0 left-0 h-full w-70 lg:w-75 bg-mantle transition-transform duration-300 ease-in-out flex-col flex ${
